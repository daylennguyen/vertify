...
reported by opening a private contact through GitHub (see
[SECURITY.md](SECURITY.md) for private reporting) or by contacting the
maintainer via [github.com/daylennguyen](https://github.com/daylennguyen).
