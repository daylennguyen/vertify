...
Not yet. Use `--dry-run`, copy the command, and edit it. A passthrough flag is a reasonable future feature — [open an issue](https://github.com/daylennguyen/vertify/issues/new/choose).
